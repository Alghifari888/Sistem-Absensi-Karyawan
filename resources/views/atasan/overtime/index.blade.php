                            ...
                            <tbody>
                                @forelse ($overtimes as $overtime)
                                    <tr class="text-center">
                                        <td class="py-2 px-4 border-b">{{ $overtime->user->name }}</td>
                                        <td class="py-2 px-4 border-b">{{ \Carbon\Carbon::parse($overtime->overtime_date)->format('d/m/Y') }}</td>
                                        <td class="py-2 px-4 border-b">{{ $overtime->start_time }} - {{ $overtime->end_time }}</td>
                                        ...
                                        <td class="py-2 px-4 border-b">
                                            <a href="{{ route('atasan.overtime.edit', $overtime) }}">
                                                <x-secondary-button>
                                                    Proses
                                                </x-secondary-button>
                                            </a>
